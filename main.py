...
exercise_db = [
    {
        ...
        "video_url": "https://www.youtube.com/watch?v=Bw2McHWunzI", # 실제 작동하는 수영 기본 영상
    ...
    },
    {
        ...
        "video_url": "https://www.youtube.com/watch?v=8TOCQCSDGcc", # 실제 작동하는 요가 기초 영상
    ...
    },
    {
        ...
        "video_url": "https://www.youtube.com/watch?v=Sd4M9hyK1Ss", # 실제 작동하는 러닝 초보 가이드
    ...
    },
    {
        ...
        "video_url": "https://www.youtube.com/watch?v=YDZjUrnfMU4", # 실제 작동하는 초보 홈트 루틴
    ...
    },
    {
        ...
        "video_url": "https://www.youtube.com/watch?v=eiBvcWmiDDY", # 실제 작동하는 헬린이 가이드
        "tags": {"goal": "근력/다이어트", "type": "혼자", "place": "실내", "impact": "medium"}
    },
    {
        "name": "등산 / 트레킹 ⛰️",
        ...
        "video_url": "https://www.youtube.com/watch?v=HoEaSgusI0A", # 실제 작동하는 등산 입문 영상
    ...
    },
    {
        ...
        "video_url": "https://www.youtube.com/watch?v=pvkHHMnArKw", # 실제 작동하는 크로스핏 기초
    ...
    },
    {
        ...
        "video_url": "https://www.youtube.com/watch?v=vT_hqAsClZY", # 실제 작동하는 테니스 1편 영상
...
with st.form("exercise_form"):
    ...
    # Q6. 투자 가능 시간 (객관식 버튼으로 수정됨)
    q6 = st.radio(
        "6. 하루에 운동에 투자할 수 있는 시간은 어느 정도인가요?",
        ["15~30분 (바쁨)", "1시간 정도 (보통)", "2시간 이상 (여유)"]
    )
